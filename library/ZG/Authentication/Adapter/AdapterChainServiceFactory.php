...
use ZG\Authentication\Adapter\AdapterChain;
use Users\Options\ModuleOptions;
use ZG\Authentication\Adapter\Exception\OptionsNotFoundException;
...
class AdapterChainServiceFactory implements FactoryInterface{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator) {
        ...
        foreach($options->getAuthAdapters() as $priority => $adapterName) {
            ...
            if (is_callable(array(
                ...
                $chain->getEventManager()
                    ->attach('authenticate',array(
                            $adapter, 'authenticate'
                        ),$priority);
            }
            if (is_callable(array(
    ...
    public function getOptions(ServiceLocatorInterface $serviceLocator = null) {
        ...
        if (!$this->options) {
            ...
            $this->setOptions($serviceLocator->get('users_module_options'));
        }
        return $this->options;
    }
}
