...
/**
 * Http Streams based implementation of AbstractIO.
 *
 */
...
use ZG\Services\Google\IO\IOException;
use ZG\Services\Google\Client;

class HttpStreamIO extends AbstractIO {
   ...
   * and then calls HttpStreamIO::makeRequest on the signed request
   *
   ...
   * @return HttpRequest http request with the response http code,
